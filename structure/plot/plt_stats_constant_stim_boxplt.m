...
figname1=['error_const_',namet{ctype}];
figname2=['cost_const_',namet{ctype}];
figname3=['net_const_',namet{ctype}];
figname4=['r_const_',namet{ctype}];
figname5=['fr_const_',namet{ctype}];
figname6=['CV_const_',namet{ctype}];

addpath('/Users/vkoren/ei_net/result/connectivity/');
savefile='/Users/vkoren/ei_net/figure/structure/constant_stim/';
...
measures={'encoding error (RMSE)','metabolic cost (MC)','net synaptic input [mV] (average balance)',...
    'correlation coefficient (inst. balance)','firing rate [Hz]','coefficient of variation (constant stim.)'};
ntr=size(fr,1);
