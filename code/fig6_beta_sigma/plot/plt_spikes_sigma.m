%% generates and plots spike trains for several values of noise strength sigma
...
for ii=1:n
    ...
    text(1.01,0.3,['\sigma = ',sprintf('%1.0f',sigma_vec(ii))],'units','normalized','fontsize',fs,'Rotation',35)
...
h1 = xlabel ('time [ms]','units','normalized','Position',[0.5,-0.05,0],'fontsize',fs);
