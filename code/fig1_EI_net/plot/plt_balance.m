%% plots distribution of net synaptic currents (average balance) across neurons
% plots distribution of correlation coefficients of synaptic currents
% (instantaneous balance) across neurons
