...
%% plots change in firing rate upon activity perturbation
% optimal network in presence of weak feedforward input
...
pos_vec=[0,0,16,11];
figname=['perturbation_ap',sprintf('%1.0i',a_p*10),'_as',sprintf('%1.0i',a_s*10)];
...
col={gray,orange};                               % for "different", "similar"
coltxt={darkgray,orange};
...
title(['weak feedforward stimulus; a_p=',sprintf('%0.1f',a_p)])
