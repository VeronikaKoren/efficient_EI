%% plots the average loss with the 1 cell type model and E neurons of the E-I model with weighting of error vs cost of 0.7
% plots the average loss across all weigthings

clear
close all

N1ct=400; %can be 400 or 500; the number of neurons in the 1 cell type network 
g_l=0.7;
